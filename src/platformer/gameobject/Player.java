...
public class Player extends GameObject implements ICollider, IUpdatable, IDrawable {
	...
	// (current) horizontal & vertial speed
	private double hsp = 0;
	private double vsp = 0;
	
	// default horizontal and vertical speed
	...
	public void onUpdate() {
		...
		// Checks the player y. If player y is too large
	...
	public void onDraw(Graphics g) {
		...
		if (this.hsp < 0.2) {
			...
			// Retrive the image back from the animation service
	...
	// (frames). the game run 30 frames / seconds
	// 
